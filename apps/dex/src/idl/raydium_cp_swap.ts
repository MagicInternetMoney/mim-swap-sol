...
export type RaydiumCpSwap = {
  address: "HBcK8eBUSWW3YGgrWv1aUpsMF6GtgkjwkcoBiHMw8gxY";
  metadata: {
    name: "raydiumCpSwap";
    version: "0.2.0";
    spec: "0.1.0";
      ...
      accounts: [
        {
          ...
          writable: true;
          signer: true;
          address: "G5mgpU51BzRyG5u294aVnecaxhW121iig4Eg3wXPAVda";
        },
        {
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          writable: true;
          address: "9xBAJLDnp9PyGUtr1RNzJbQhYt3CXSD6FvCxYFa9VZWG";
        },
        {
      ...
      args: [
        ...
        {
          name: "poolTradeFeeRate";
          type: "u64";
        },
      ];
    },
    {
      name: "initializeWithPermission";
      docs: [
