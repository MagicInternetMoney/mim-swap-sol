...
export type DexWallet = MimWallet;
...
export function createMimWallets(): MimWallet[] {
  return [
...
export function createDexWallets(): MimWallet[] {
  return createMimWallets();
}

export function createTreasuryWallets(): MimWallet[] {
  return createMimWallets();
}

export function createWalletDescriptor(adapter: Adapter): MimWallet {
